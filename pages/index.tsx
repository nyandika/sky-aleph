      ...
      <nav className='navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row'>
        <div className='text-center navbar-brand-wrapper d-flex align-items-center justify-content-center'>
          <a className='navbar-brand brand-logo mr-5' href='/'>
            <img src='../logo.svg' className='mr-2' alt='logo' />
          </a>
          ...
          <div className='tab-content' id='setting-content'>
            ...
            >
              ...
              <ul className='chat-list'>
                ...
                <li className='list'>
                  <div className='profile'>
                    <img src='../images/face6.jpg' alt='image' />
                    <span className='online'></span>
                  </div>
                  <div className='info'>
                    <p>Sarah Graves</p>
                    ...
                    <div className='justify-content-end d-flex'>
                      <div className='dropdown flex-md-grow-1 flex-xl-grow-0'>
                        <button
                          ...
                          aria-expanded='true'
                        >
                          <i className='mdi mdi-calendar'></i> Today (10 Jan
                          2021)
                        </button>
                        <div
                      ...
                      <div className='d-flex'>
                        <div>
                          <h2 className='mb-0 font-weight-normal'>
                            <i className='icon-sun mr-2'></i>31
                            <sup>C</sup>
                          </h2>
                        </div>
                        <div className='ml-2'>
                ...
                <div className='card'>
                  <div className='card-body'>
                    ...
                    <ul className='icon-data-list'>
                      <li>
                        <div className='d-flex'>
                          <img src='../images/face1.jpg' alt='user' />
                          <div>
                      ...
                      <li>
                        <div className='d-flex'>
                          <img src='../images/face2.jpg' alt='user' />
                          <div>
                      ...
                      <li>
                        <div className='d-flex'>
                          <img src='../images/face3.jpg' alt='user' />
                          <div>
                      ...
                      <li>
                        <div className='d-flex'>
                          <img src='../images/face4.jpg' alt='user' />
                          <div>
                      ...
                      <li>
                        <div className='d-flex'>
                          <img src='../images/face5.jpg' alt='user' />
                          <div>
